...
class DerivativesGxy():
    '''
    Partial derivatives of weight function G for different parameter combinations
    '''
    n1Max = 2
    alpha1Max = 4
    beta1Max = 4
    ...
    def __init__(self,halfWindowVec,case):
        '''
        Initialization of method partialGxy in function of the parameter
        combination number once and for all to avoid repeated tests
        '''
