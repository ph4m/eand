...
import numpy as np
from eand.irreg import Irreg2D
...
irreg2D = Irreg2D(n1,n2,alpha1,beta1,alpha2,beta2,t1,t2,T1,T2)

# IMPORTANT
signal = irreg2D.sortSignal(signal)

irreg2D.plotDelaunay(0)

print 'COMMENCING DIFFERENTIATION'
(t1Post,t2Post,dPost) = irreg2D.differentiate(signal)
...
irreg2D.plotEstimate(t1Post, t2Post, dPost)
