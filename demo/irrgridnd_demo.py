...
import numpy as np
from eand.irrgrid import IrrGridND
...
(tPostVec,dPost) = irrGridND.differentiate(signal)

print 'Calculating reference derivative...'
tSlice,dSlice = irrGridND.plotSlice(tPostVec,dPost,1,0.,0.1)
dRef = []
for i in tSlice:
...
irrGridND.plotScatter(tPostVec, dPost)
