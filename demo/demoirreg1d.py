...
import numpy as np
from eand.irreg import Irreg1D
...
irreg1D = Irreg1D(n1,alpha1,beta1,t1,T1)

# IMPORTANT
signal = irreg1D.sortSignal(signal)

irreg1D.plotPartition(0)

#print irreg1D.partitionSegments
#print irreg1D.partitionCenters

print 'COMMENCING DIFFERENTIATION'
(t1Post,dPost) = irreg1D.differentiate(signal)
...
irreg1D.plotScatter(t1Post, dPost)
